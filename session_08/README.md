...
### These are the model parameters (same for all models):
...
├─ConvBlock (conv_block1)                --                 [2, 3, 32, 32]     [2, 16, 32, 32]    --                 True
│    └─Sequential (block)                --                 [2, 3, 32, 32]     [2, 16, 32, 32]    --                 True
│    │    └─ConvLayer (0)                --                 [2, 3, 32, 32]     [2, 16, 32, 32]    --                 True
│    │    │    └─Conv2d (conv)           [3, 3]             [2, 3, 32, 32]     [2, 16, 32, 32]    432                True
│    │    │    └─BatchNorm2d (norm)      --                 [2, 16, 32, 32]    [2, 16, 32, 32]    32                 True
│    │    │    └─ReLU (activation)       --                 [2, 16, 32, 32]    [2, 16, 32, 32]    --                 --
│    │    │    └─Dropout (drop)          --                 [2, 16, 32, 32]    [2, 16, 32, 32]    --                 --
│    │    └─ConvLayer (1)                --                 [2, 16, 32, 32]    [2, 16, 32, 32]    --                 True
│    │    │    └─Conv2d (conv)           [3, 3]             [2, 16, 32, 32]    [2, 16, 32, 32]    2,304              True
│    │    │    └─BatchNorm2d (norm)      --                 [2, 16, 32, 32]    [2, 16, 32, 32]    32                 True
│    │    │    └─ReLU (activation)       --                 [2, 16, 32, 32]    [2, 16, 32, 32]    --                 --
│    │    │    └─Dropout (drop)          --                 [2, 16, 32, 32]    [2, 16, 32, 32]    --                 --
├─TransBlock (trans_block1)              --                 [2, 16, 32, 32]    [2, 24, 16, 16]    --                 True
│    └─Sequential (layer)                --                 [2, 16, 32, 32]    [2, 24, 16, 16]    --                 True
│    │    └─Conv2d (0)                   [1, 1]             [2, 16, 32, 32]    [2, 24, 32, 32]    384                True
│    │    └─MaxPool2d (1)                [2, 2]             [2, 24, 32, 32]    [2, 24, 16, 16]    --                 --
├─ConvBlock (conv_block2)                --                 [2, 24, 16, 16]    [2, 24, 16, 16]    --                 True
│    └─Sequential (block)                --                 [2, 24, 16, 16]    [2, 24, 16, 16]    --                 True
│    │    └─ConvLayer (0)                --                 [2, 24, 16, 16]    [2, 24, 16, 16]    --                 True
...
│    │    │    └─ReLU (activation)       --                 [2, 24, 16, 16]    [2, 24, 16, 16]    --                 --
│    │    │    └─Dropout (drop)          --                 [2, 24, 16, 16]    [2, 24, 16, 16]    --                 --
├─TransBlock (trans_block2)              --                 [2, 24, 16, 16]    [2, 32, 8, 8]      --                 True
│    └─Sequential (layer)                --                 [2, 24, 16, 16]    [2, 32, 8, 8]      --                 True
│    │    └─Conv2d (0)                   [1, 1]             [2, 24, 16, 16]    [2, 32, 16, 16]    768                True
│    │    └─MaxPool2d (1)                [2, 2]             [2, 32, 16, 16]    [2, 32, 8, 8]      --                 --
├─ConvBlock (conv_block3)                --                 [2, 32, 8, 8]      [2, 32, 8, 8]      --                 True
│    └─Sequential (block)                --                 [2, 32, 8, 8]      [2, 32, 8, 8]      --                 True
│    │    └─ConvLayer (0)                --                 [2, 32, 8, 8]      [2, 32, 8, 8]      --                 True
│    │    │    └─Conv2d (conv)           [3, 3]             [2, 32, 8, 8]      [2, 32, 8, 8]      9,216              True
│    │    │    └─BatchNorm2d (norm)      --                 [2, 32, 8, 8]      [2, 32, 8, 8]      64                 True
│    │    │    └─ReLU (activation)       --                 [2, 32, 8, 8]      [2, 32, 8, 8]      --                 --
│    │    │    └─Dropout (drop)          --                 [2, 32, 8, 8]      [2, 32, 8, 8]      --                 --
│    │    └─ConvLayer (1)                --                 [2, 32, 8, 8]      [2, 32, 8, 8]      --                 True
│    │    │    └─Conv2d (conv)           [3, 3]             [2, 32, 8, 8]      [2, 32, 8, 8]      9,216              True
│    │    │    └─BatchNorm2d (norm)      --                 [2, 32, 8, 8]      [2, 32, 8, 8]      64                 True
│    │    │    └─ReLU (activation)       --                 [2, 32, 8, 8]      [2, 32, 8, 8]      --                 --
│    │    │    └─Dropout (drop)          --                 [2, 32, 8, 8]      [2, 32, 8, 8]      --                 --
│    │    └─ConvLayer (2)                --                 [2, 32, 8, 8]      [2, 32, 8, 8]      --                 True
│    │    │    └─Conv2d (conv)           [3, 3]             [2, 32, 8, 8]      [2, 32, 8, 8]      9,216              True
│    │    │    └─BatchNorm2d (norm)      --                 [2, 32, 8, 8]      [2, 32, 8, 8]      64                 True
│    │    │    └─ReLU (activation)       --                 [2, 32, 8, 8]      [2, 32, 8, 8]      --                 --
│    │    │    └─Dropout (drop)          --                 [2, 32, 8, 8]      [2, 32, 8, 8]      --                 --
├─Sequential (output_block)              --                 [2, 32, 8, 8]      [2, 10]            --                 True
│    └─AdaptiveAvgPool2d (0)             --                 [2, 32, 8, 8]      [2, 32, 1, 1]      --                 --
│    └─Conv2d (1)                        [1, 1]             [2, 32, 1, 1]      [2, 10, 1, 1]      320                True
...
- ## Batch Normalization
  - Total Parameters = 47,808
  - Best training accuracy = 78.99%
  - Best testing accuracy = 77.94%
- ## Group Normalization (# Groups = 8)
  - Total Parameters = 47,808
  - Best training accuracy = 74.41%
  - Best testing accuracy = 73.17%
- ## Layer Normalization
  - Total Parameters = 47,808
  - Best training accuracy = 72.18%
  - Best testing accuracy = 70.79%    
